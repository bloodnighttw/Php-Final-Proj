        ...
        <div class="container rounded shadow bg-dark content">
            ...
            <div>
                <div class="d-flex align-items-center">
                    ...
                    <div class="p-2 vote"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
            ...
            <div>
                <div class="by">
                    ...
                    <div class="d-flex ">
                        <div class="padding-left0  flex-grow-1"><p class="padding-left0"> by <img src="https://avatars.githubusercontent.com/u/44264182" alt="avatars" height="24"
                            width="auto" class="img" class="rounded-circle"> bloodnighttw </p></div>
                        
                        <div class="badge-list" >
                            <img src="./img/badge1.png" class="badge-img">
                            <div class="badge-content shadow bg-dark rounded border-5"> <h6>榮譽獎章</h6> <p>你可以在此處購買獎章獎勵你喜歡的文章</p></div>
                        </div>
                        <div class="badge-list" >
                            <img src="./img/badge1.png" class="badge-img">
                            <div class="badge-content shadow bg-dark rounded border-5"> <h6>榮譽獎章</h6> <p>你可以在此處購買獎章獎勵你喜歡的文章</p></div>
            ...
            <div class="container rounded shadow bg-dark content">
                ...
                <div>
                    ...
                    <div class="d-flex  align-items-center comme">
                        <div class=".padding-left0 p-2 me-auto ">
                            <div class="">
                                <img src="https://avatars.githubusercontent.com/u/44264182" alt="avatars" height="30"
                                    width="auto" class="img" class="rounded-circle">
                            </div>
                        </div>
                        ...
                        <div class="p-2 vote"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
